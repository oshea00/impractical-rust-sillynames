...
const FIRST_NAMES: [&str;68] = ["Baby Oil", "Bad News", "Big Burps", "Bill 'Beenie-Weenie'",
...
"Skidmark", "Slaps", "Snakes", "Snoobs",
"Snorki", "Soupcan Sam", "Spitzitout", "Squids", "Stinky",
"Storyboard", "Sweet Tea", "TeeTee", "Wheezy Joe",
"Winston 'Jazz Hands'", "Worms"];


const LAST_NAMES: [&str;65] = ["Appleyard", "Bigmeat", "Bloominshine", "Boogerbottom",
...
fn main() {
    ...
    let how_many = input("How many names? ").parse::<u32>().unwrap_or_else(|_|{1});
